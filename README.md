...
| [fetch-event-receipts](skills/fetch-event-receipts/SKILL.md) | Retrieve final DoorDash, ezCater, or Instacart receipts through a persistent Browserbase Context, match them exactly to Ramp transactions, and attach them through a standalone Ramp Agent Identity |
