...
| [browserbase-doctor](skills/browserbase-doctor/SKILL.md) | Diagnose Browserbase session failures from customer-authorized session metadata, CDP logs, and application errors with redacted, evidence-backed reports |
